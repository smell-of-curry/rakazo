export const RU_MESSAGES: Record<string, string> = {
  ...
  "Needs you": "Требуется ваше участие",
  ...
  "{peer} rate-limited": "{peer} — лимит запросов",
  Messaged: "Написано",
  "{count} messages with": "{count} сообщений с",
  "{count} Bots": "{count} ботами",
  ...
  Marketplace: "Каталог",
  Off: "Выкл.",
  "Paste value": "Вставить значение",
  Profile: "Профиль",
  "Rate limited · retrying in {s}s": "Лимит · повтор через {s} с",
  Reopen: "Открыть снова",
  Routines: "Задачи",
  "Save securely": "Сохранить безопасно",
  Settings: "Настройки",
  "Setting up…": "Настройка…",
  "Setting up {name}'s computer…": "Настройка компьютера {name}…",
  Sleeping: "Спит",
  "Stored securely, never shown to your bot": "Надёжно сохранено, бот это не увидит",
  "Type an answer": "Введите ответ",
