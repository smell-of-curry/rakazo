export const ZH_MESSAGES: Record<string, string> = {
  ...
  "{peer} rate-limited": "{peer} 已限流",
  Messaged: "已发消息给",
  "{count} messages with": "{count} 条消息，与",
  ...
  "Paste value": "粘贴值",
  Profile: "资料",
  "Rate limited · retrying in {s}s": "已限流 · {s} 秒后重试",
  Reopen: "重新打开",
  Routines: "例行任务",
  "Save securely": "安全保存",
  Settings: "设置",
  "Setting up…": "正在设置…",
  "Setting up {name}'s computer…": "正在设置 {name} 的电脑…",
  Sleeping: "休眠",
  "Stored securely, never shown to your bot": "已安全存储，不会展示给你的 Bot",
  "Type an answer": "输入回答",
